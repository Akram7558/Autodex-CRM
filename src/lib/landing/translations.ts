...
export const translations: Record<Locale, TranslationDict> = {
  fr: {
    ...
    'login.or':                 'ou',
    'login.demo':               'Tester avec un compte démo',
    'login.demo_hint':          'Compte démo · demo@autodex.store · demo123',
  ...
  ar: {
    ...
    'login.or':                 'أو',
    'login.demo':               'جرب بحساب تجريبي',
    'login.demo_hint':          'حساب تجريبي · demo@autodex.store · demo123',
